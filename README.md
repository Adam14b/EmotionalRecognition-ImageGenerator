...
- для разработки системы не требуется покупки дополнительных ресурсов и найма новых сотрудников(задача достижима в нынешних условиях и не требует дополнительных ресурсов).
