...
горизонт прогноза:
- краткосрочный прогноз: анализ эмоционального состояния клиентов в реальном времени в процессе видеоконференции, а так же по её 	  завершению.

- долгосрочный прогноз: визуализация изменения уровня удовлетворенности на протяжении определенного периода, а так же уровень общей удовлетворенности работой персонального менеджера в этот период времени. 
