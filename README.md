...
- модель генерации пояснительных иллюстраций:
	...
	- описание: визуализации должны быть интерактивными и объясняющими разницу в доходности на простых вещах (например, деревья различной высоты, показывающие разницу в доходности банковских продуктов.) Под каждым примером доходности должна быть пояснительная надпись, к какому продукту относится та или иная часть иллюстрации. 
