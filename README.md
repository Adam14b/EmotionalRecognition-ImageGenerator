...
За каждым клиентом закреплен сопровождательный менеджер, сопровождающий клиента, в том числе через платформу "Dion".
