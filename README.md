...
> - 'Общая удовлетворенность': $\frac{\frac{NeutralAmount}{2} + PositiveAmount}{\frac{NeutralAmount}{2} + PositiveAmount + NegativeAmount} \cdot 100\\%$ (нейтральные эмоции имеют коэффициент ```0.5```, так как они в меньшей степени влияют на удовлетворенность клиента конференцией)
> - 'негативные эмоции': \frac{NegativeAmount}{NeutralAmount + PositiveAmount + NegativeAmount} \cdot 100\\%$
> - 'нейтральные эмоции': \frac{NeutralAmount}{NeutralAmount + PositiveAmount + NegativeAmount} \cdot 100\\%$
