...
- система должна в реальном времени обрабатывать данные для ```МКЭ```(максимальная задержка - 100мс)  и ```МГПИ``` (максимальная задержка - 15с);
...
- необходимость закупить серверы, при отсутсвии доступных серверов для размещения системы;
- необходимость поддерживать серверы в 
